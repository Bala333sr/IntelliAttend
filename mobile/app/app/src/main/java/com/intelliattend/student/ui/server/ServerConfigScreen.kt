                ...
                Button(
                    onClick = {
                        if (validateServerUrl(serverUrl)) {
                            ...
                            // Normalize: ensure base URL ends with /api/
                            val normalized = normalizeBaseUrl(serverUrl)
                            app.getAppPreferences().baseUrl = normalized
...
private fun normalizeBaseUrl(url: String): String {
    ...
    if (u.endsWith("/api")) u = "$u/"
    if (!u.endsWith("/api/")) {
        // If it already contains /api/ somewhere else at the end, remove extra slashes
