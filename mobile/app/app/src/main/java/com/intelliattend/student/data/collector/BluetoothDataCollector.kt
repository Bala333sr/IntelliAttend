package com.intelliattend.student.data.collector
...
class BluetoothDataCollector(private val context: Context) {
    ...
    private var onDevicesUpdated: ((List<com.intelliattend.student.data.model.BluetoothData>) -> Unit)? = null
     ...
     */
    fun startScanning(onDevicesUpdated: (List<com.intelliattend.student.data.model.BluetoothData>) -> Unit) {
    ...
    private fun processScanResult(result: ScanResult) {
        ...
        val bluetoothDevice = com.intelliattend.student.data.model.BluetoothData(
            name = displayName,
            address = address,
            rssi = result.rssi
        )
     ...
     */
    fun getPairedDevices(): List<com.intelliattend.student.data.model.BluetoothData> {
        ...
        return bluetoothAdapter?.bondedDevices?.map { device ->
            ...
            com.intelliattend.student.data.model.BluetoothData(
                name = displayName,
