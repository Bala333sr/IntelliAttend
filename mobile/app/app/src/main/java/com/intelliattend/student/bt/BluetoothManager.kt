...
class BluetoothManager(private val context: Context) {
    ...
    fun startBleScan() {
        try {
            ...
            android.util.Log.e("BluetoothManager", "Error starting BLE scan", e)
        }
    }
    ...
    fun stopBleScan() {
        try {
            ...
            android.util.Log.e("BluetoothManager", "Error stopping BLE scan", e)
        }
    }
    ...
    fun startClassicDiscovery() {
        try {
            ...
            android.util.Log.e("BluetoothManager", "Error starting classic discovery", e)
        }
    }
    ...
    fun stopClassicDiscovery() {
        try {
            ...
            android.util.Log.e("BluetoothManager", "Error stopping classic discovery", e)
        }
        try {
            bluetoothAdapter?.cancelDiscovery()
        } catch (e: Exception) {
            android.util.Log.e("BluetoothManager", "Error canceling discovery", e)
        }
    }
    ...
    fun cleanup() {
        try {
            ...
            android.util.Log.e("BluetoothManager", "Error unregistering bluetooth state receiver", e)
        }
        try {
            stopBleScan()
            stopClassicDiscovery()
        } catch (e: Exception) {
            android.util.Log.e("BluetoothManager", "Error stopping scans during cleanup", e)
        }
    }
