-- Insert sample students first (required for foreign key constraints)
INSERT INTO students (student_code, first_name, last_name, email, phone_number, year_of_study, program, password_hash) VALUES
('STU001', 'Alice', 'Williams', 'alice.williams@student.edu', '+1234567893', 2, 'Computer Science', '$2b$12$LQv3c1yqBwUVHdkuLM3uXeH6GS'),
