#!/usr/bin/env python3
"""
Script to add timetable API endpoints to app.py
"""
...
def add_timetable_endpoints():
    """Add timetable API endpoints to app.py"""
    
    # Read the current app.py file
    with open('app.py', 'r') as f:
        content = f.read()
    
    # Define the new API endpoints
    new_endpoints = '''
...
'''
    ...
    # Find a good place to insert the new endpoints (after the existing timetable endpoints)
    # Look for the end of the existing timetable endpoints
    insert_position = content.find("# ============================================================================\n# OTP MANAGEMENT ROUTES\n# ===========================================================================")
    
    if insert_position == -1:
        # If not found, try to find another good position
        insert_position = content.find("@app.route('/api/faculty/generate-otp'")
    ...
    new_content = content[:insert_position] + new_endpoints + "\n" + content[insert_position:]
    
    # Write the updated content back to the file
    with open('app.py', 'w') as f:
        f.write(new_content)
    
    print("✅ Timetable API endpoints added successfully to app.py!")

if __name__ == '__main__':
    add_timetable_endpoints()